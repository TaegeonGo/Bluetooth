    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                ...
                case 1:
                    return new ExpenditureActivity();
                case 2:
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return String.valueOf(R.string.tab_text_1);
                case 1:
                    return String.valueOf(R.string.tab_text_2);
                case 2:
                    return String.valueOf(R.string.tab_text_3);
            }
            return null;
        }
    }
